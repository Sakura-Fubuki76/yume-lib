...
Java_io_github_sakurafubuki_yume_nativelib_mediainfo_MediaThumbnailRetriever_nativeCreateFromPath(
        JNIEnv *env,
        jobject thiz,
        jstring file_path) {
...
extern "C"
JNIEXPORT jlong JNICALL
Java_io_github_sakurafubuki_yume_nativelib_mediainfo_MediaThumbnailRetriever_nativeCreateFromFD(
        JNIEnv *env,
        jobject thiz,
...
Java_io_github_sakurafubuki_yume_nativelib_mediainfo_MediaThumbnailRetriever_nativeGetEmbeddedPicture(
        JNIEnv *env,
        jobject thiz,
        jlong handle) {
...
Java_io_github_sakurafubuki_yume_nativelib_mediainfo_MediaThumbnailRetriever_nativeGetFrameAtTime(
        JNIEnv *env,
        jobject thiz,
        jlong handle,
        jlong time_us) {
...
extern "C"
JNIEXPORT jobject JNICALL
Java_io_github_sakurafubuki_yume_nativelib_mediainfo_MediaThumbnailRetriever_nativeGetFrameAtIndex(
        JNIEnv *env,
        jobject thiz,
        jlong handle,
        jint frame_index) {
...
Java_io_github_sakurafubuki_yume_nativelib_mediainfo_MediaThumbnailRetriever_nativeGetRotationDegrees(
        JNIEnv *env,
        jobject thiz,
        jlong handle) {
    auto *context = context_from_handle(handle);
...
Java_io_github_sakurafubuki_yume_nativelib_mediainfo_MediaThumbnailRetriever_nativeRelease(
        JNIEnv *env,
        jobject thiz,
        jlong handle) {
    auto *context = context_from_handle(handle);
