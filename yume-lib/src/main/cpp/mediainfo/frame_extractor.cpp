...
Java_io_github_sakurafubuki_yume_nativelib_mediainfo_FrameLoader_nativeRelease(JNIEnv *env, jclass clazz,
                                                                        jlong jFrameLoaderContextHandle) {
    frame_loader_context_free(jFrameLoaderContextHandle);
}
extern "C"
JNIEXPORT jboolean JNICALL
Java_io_github_sakurafubuki_yume_nativelib_mediainfo_FrameLoader_nativeLoadFrame(JNIEnv *env, jclass clazz,
                                                                          jlong jFrameLoaderContextHandle,
                                                                          jlong time_millis,
                                                                          jobject jBitmap) {
...
Java_io_github_sakurafubuki_yume_nativelib_mediainfo_FrameLoader_nativeGetFrame(JNIEnv *env, jclass clazz,
                                                                         jlong jFrameLoaderContextHandle,
                                                                         jlong time_millis) {
