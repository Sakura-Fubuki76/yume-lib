...
Java_io_github_sakurafubuki_yume_nativelib_mediainfo_MediaInfoBuilder_nativeCreateFromFD(JNIEnv *env,
                                                                                  jobject thiz,
...
extern "C"
JNIEXPORT void JNICALL
Java_io_github_sakurafubuki_yume_nativelib_mediainfo_MediaInfoBuilder_nativeCreateFromPath(JNIEnv *env,
                                                                                    jobject thiz,
                                                                                    jstring jFilePath) {
