...
@UnstableApi
open class YumeRenderersFactory(context: Context) : DefaultRenderersFactory(context) {
    ...
    override fun buildTextRenderers(
        ...
        out.add(YumeTextRenderer(output, outputLooper))
    }

    companion object {
        const val TAG = "YumeRenderersFactory"
    }
}
